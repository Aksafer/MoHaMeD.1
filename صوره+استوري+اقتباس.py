...
async def ihd(client: Client, message: Message):
    ...
    await client.send_photo(message.chat.id,url,caption="- Join.Channel.SouRce : @SOURCE_EROR ⋅",
...
async def ihd(client: Client, message: Message):
    ...
    await client.send_audio(message.chat.id,url,caption="- Join.Channel.SouRce : @SOURCE_EROR ⋅",
    reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
